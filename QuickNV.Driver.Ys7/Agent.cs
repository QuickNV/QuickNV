...
namespace QuickNV.Driver.Ys7
{
    public class Agent : AbstractDriverAgent<ConfigModel, DeviceConfig, ChannelConfig>
    {
        ...
        protected override Protocol.Driver.QpCommands.DestoryChannelStream.Response DestoryChannelStream(QpChannel qpChannel, Protocol.Driver.QpCommands.DestoryChannelStream.Request request)
        {
